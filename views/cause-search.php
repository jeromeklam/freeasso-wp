	...
	<form role="search" class="search-form freeasso-cause-search-form">
		<div class="freeasso-cause-search-input-group">
			...
			<select id="freeasso-cause-search-gender"
				...
				<?php
				foreach ($this->gender as $oneGender) {
				?>
		...
		<div class="freeasso-cause-search-input-group">
			...
			<select id="freeasso-cause-search-site"
				...
				<option value="" <?php echo $this->getParam('freeasso-cause-search-site') == '' ? 'selected' : '' ?>><?php esc_html_e( 'Tous', 'freeasso' ); ?></option>
				<?php
				foreach ($this->sites as $oneSite) {
				?>
					<option value="<?php echo $oneSite->id; ?>" <?php echo $oneSite->id == $this->getParam('freeasso-cause-search-site') ? 'selected' : '' ?>><?php echo $oneSite->label; ?></option>
				<?php
				}
				?>
			</select>
		...
		<div class="freeasso-cause-search-input-group">
			...
			<select id="freeasso-cause-search-species"
				...
				<option value="" <?php echo $this->getParam('freeasso-cause-search-species') == '' ? 'selected' : '' ?>><?php esc_html_e( 'Tous', 'freeasso' ); ?></option>
				<?php
				foreach ($this->species as $oneSpecies) {
				?>
					<option value="<?php echo $oneSpecies->id; ?>" <?php echo $oneSpecies->id == $this->getParam('freeasso-cause-search-species') ? 'selected' : '' ?>><?php echo $oneSpecies->label; ?></option>
				<?php
				}
				?>
			</select>
