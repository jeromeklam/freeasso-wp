...
class Freeasso_Api_Amounts extends Freeasso_Api_Base
{
    ...
    protected function __construct()
    {
        ...
        $this->amounts = [
            ...
            'CHF' => [
                (object)['id' => 'C', 'label' => translate('Tous les gibbons à parrainer'            ,'freeasso'), 'gte' => 1],
                (object)['id' => 'A', 'label' => translate('290CHF ou 24,16CHF/mois (parrainage complet)','freeasso'), 'gte' => 290],
                (object)['id' => 'Z', 'label' => translate('Déjà parrainé en totalité'               ,'freeasso'), 'lt'  => 1],
                (object)['id' => '-', 'label' => '---'],
                (object)['id' => 'K', 'label' => translate('200 à 290CHF'       ,'freeasso'), 'lt' => 290, 'gte' => 200],
                ...
                (object)['id' => '-', 'label' => '---'],
                (object)['id' => 'L', 'label' => translate('10 à 24CHF/mois'    ,'freeasso'), 'lt' => 290, 'gte' => 120],
                (object)['id' => 'I', 'label' => translate('5 à 9CHF/mois'      ,'freeasso'), 'lt' => 120, 'gte' => 60],
                (object)['id' => 'F', 'label' => translate('5CHF/mois et plus'  ,'freeasso'), 'gte' => 60]
            ]
        ];
    }
}