			...
			?>
				<div class="freeasso-cause-search-animals-thumbnail" data-cause-id="<?php echo $oneCause->id; ?>" data-left-to-raise="<?php echo $oneCause->left; ?>">
					...
					<div class="freeasso-cause-search-animals-picture">
						<div>
							<a class="fancybox-iframe" alt="vignette" 
								href="?freeasso-cause-mode=detail&freeasso-cause-id=<?php echo $oneCause->id; ?>&ami=<?php echo $this->getParam('ami')?'1':'0'; ?>"
					...
					<div class="freeasso-cause-search-animals-bottom">
						<a class="freeasso-cause-search-animals-go fancybox-iframe" href="?freeasso-cause-mode=detail&freeasso-cause-id=<?php echo $oneCause->id; ?>&freeasso-cause-search-money=<?php echo $currency; ?>&ami=<?php echo $this->getParam('ami')?'1':'0'; ?>"><?php esc_html_e('Détails', 'freeasso'); ?></a>
